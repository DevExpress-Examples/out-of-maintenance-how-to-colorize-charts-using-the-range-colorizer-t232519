...
'            #Region "#BarSeries"
            ...
            Dim bubbleSeries As New Series() With {.DataSource = LoadData(filepath), .Colorizer = CreateColorizer(), .ArgumentDataMember = "Country", .ColorDataMember = "Hpi", .View = New SideBySideBarSeriesView()}
